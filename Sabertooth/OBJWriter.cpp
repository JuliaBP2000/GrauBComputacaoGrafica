...
void OBJWriter::addFaces(int index, int externalCurveSize, int faces, int n) 
{
...
void OBJWriter::addNormalExternalCurve(glm::vec3 normal_vec_abac, glm::vec3 normal_vec_dbdc) 
{
	OBJFile.open("../objs/pista.obj", ios::app);
...
void OBJWriter::addPointsFinalCurve(float x, float y, float z) 
{
	OBJFile.open("../objs/pista.obj", ios::app);
...
void OBJWriter::saveTextureValuesToOBJ() 
{
	OBJFile.open("../objs/pista.obj", ios::app);
	OBJFile << endl;
